...
public class AsyncTaskTest {
    ...
    private static class TestList extends CopyOnWriteArrayList<String>{
        @Override
        public int hashCode() {
            return 1;
        }
    ...
    private static class TestOrderTask extends Task<Boolean>{
        ...
        protected TestOrderTask(String id, Scheduler scheduler, List<String> list) {
            super(id, scheduler, Mode.ASYNC, Target.BACKGROUND, Cache.ONE_FRAME);
            this.list = list;
        }
    ...
    private static final Functions.Two<String,List<String>,Boolean> ADD_STRING_FUNCTION= new Functions.Two<>("ADD_STRING_FUNCTION") {
        @Override
